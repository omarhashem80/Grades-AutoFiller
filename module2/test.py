...
image_path = os.path.join(script_dir, '', 'test8.jpg')

# Load the image
image = cv2.imread(image_path)

process_image_and_grades(image, 'model_16.txt')
...
# # Build the path dynamically
# script_dir = os.path.dirname(__file__)
# test_cases_dir = os.path.join(script_dir, 'testCases/45')
#
...
#             process_image_and_grades(image, 'model_45.txt')
# else:
